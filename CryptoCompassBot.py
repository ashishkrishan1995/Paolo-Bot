...
def currentdeals(bot, update):
    ...
    bot.send_message(chat_id=update.message.chat_id, text="We have several ICOs in private sale. We share our due diligence reports on our website for free.  If you want other private sales and due diligence reports, feel free to complete", parse_mode='Markdown')
